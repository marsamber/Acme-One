...
<acme:form readonly="false" >
	...
	<acme:input-textbox readonly="true" code="inventor.item.form.label.name" path="name"/>
	<acme:input-textbox readonly="true" code="inventor.item.form.label.code" path="code"/>		
	<acme:input-textbox readonly="true" code="inventor.item.form.label.technology" path="technology"/>	
	<acme:input-textbox  code="inventor.item.form.label.description" path="description"/>
	<acme:input-money readonly="true" code="inventor.item.form.label.retailPrice" path="retailPrice"/>
	<acme:input-url readonly="true"  code="inventor.item.form.label.link" path="link"/>	
