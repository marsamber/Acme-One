...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.provider" access="hasRole('Inventor')">
			<acme:menu-suboption code="master.menu.provider.favourite-link" action="http://www.youtube.com/"/>
		</acme:menu-option>
