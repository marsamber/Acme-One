...
public class AdministratorAnnouncementCreateTest extends TestHarness{
	...
	// Lifecycle management ---------------------------------------------------
		...
		@Order(10)
		public void positiveTest(final int recordIndex, final String title, final String body, final String criticalFlag, final String link) {
		...
		@Order(20)
		public void negativeTest(final int recordIndex, final String title, final String body, final String criticalFlag, final String link) {
