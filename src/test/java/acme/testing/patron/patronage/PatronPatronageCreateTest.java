...
public class PatronPatronageCreateTest  extends TestHarness {
	...
	@Order(10)
	public void positiveTest(final int recordIndex, final String code, final String legalStuff, final String budget, final String link, final String startedAt, final String finishedAt) {
		...
		super.fillInputBoxIn("startedAt", startedAt);
		super.fillInputBoxIn("finishedAt", finishedAt);
	...
	@Order(20)
	public void negativeTest(final int recordIndex, final String code, final String legalStuff, final String budget, final String link, final String startedAt, final String finishedAt) {
