...
public class AnyInventorListAllTest extends TestHarness {

	@ParameterizedTest
	@CsvFileSource(resources = "/any/inventor/list-all.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	public void positiveTest(final int recordIndex, final String name, final String surname, final String email, final String username, final String company, final String statement, final String moreInfo) {
		...
		super.clickOnMenu("Any", "List All Inventors");
